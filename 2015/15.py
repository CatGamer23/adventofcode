  ...
  for sugar_qty in range(101):
    for sprinkles_qty in range(101 - sugar_qty):
      for chocolate_qty in range(101 - sugar_qty - sprinkles_qty):
        candy_qty: int = 100 - sugar_qty - sprinkles_qty - chocolate_qty
  ...
  for sugar_qty in range(101):
    for sprinkles_qty in range(101 - sugar_qty):
      for chocolate_qty in range(101 - sugar_qty - sprinkles_qty):
        ...
        total_calories: int = max(
          0,
          sugar_qty * ingredients[ingredient_names[0]]["calories"]
          + sprinkles_qty * ingredients[ingredient_names[1]]["calories"]
          + chocolate_qty * ingredients[ingredient_names[2]]["calories"]
          + candy_qty * ingredients[ingredient_names[3]]["calories"],
        )
